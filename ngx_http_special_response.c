...
"<hr>" CRLF
"<div style='text-align: center; font-family: Arial, sans-serif; color: #333; background-color: #f9f9f9; padding: 20px;'>" CRLF
"<a href='/' style='text-decoration: none; color: #007bff; font-size: 16px; font-weight: bold; display: inline-block; margin-bottom: 10px;'>Return to Home</a>" CRLF
"<br><br>" CRLF
"<img src='/static/image/server.svg' alt='Logo' style='width: 100px; height: auto; margin-bottom: 10px;'>" CRLF
"<br><br>" CRLF
"<span style='font-size: 14px; display: block;'>Internet</span>" CRLF
"</div>" CRLF
"</body>" CRLF
"</html>" CRLF
;
